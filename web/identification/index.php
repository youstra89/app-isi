			...
			<div class="container">
				...
				<div id="navbar" class="collapse navbar-collapse">
					<ul class="nav navbar-nav">
						...
						<li><a href="#" onclick="load('<?php echo $base_path?>user.php?action=index&regime=A')">Elèves AC</a></li>
						<li><a href="#" onclick="load('<?php echo $base_path?>user.php?action=index&regime=F')">Elèves CF</a></li>
