 ...
 * Eleverenvoye
 *
 * @ORM\Table(name="eleve_renvoye", uniqueConstraints={@ORM\UniqueConstraint(name="eleve_annee", columns={"annee_scolaire", "eleve"})}, indexes={@ORM\Index(name="eleve", columns={"eleve"}), @ORM\Index(name="annee_scolaire", columns={"annee_scolaire"})})
 * @ORM\Entity(repositoryClass="ISI\ISIBundle\Repository\EleverenvoyeRepository")
 * @UniqueEntity(
