 ...
 * AnneeContratRetard
 *
 * @ORM\Table(name="annee_contrat_retard")
 * @ORM\Entity(repositoryClass="ISI\ENSBundle\Repository\AnneeContratRetardRepository")
 */
class AnneeContratRetard
{
    /**
     * @var int
     *
